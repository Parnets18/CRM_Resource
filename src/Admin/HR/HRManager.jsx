...
export default function ConstructionHRManager() {
  const [employees, setEmployees] = useState([
    ...
    },
    {
      ...
      role: "Crane Operator",
      site: "Riverside Mall",
      certifications: ["CCO Certified", "OSHA 10"],
      hourlyRate: 42,
      joinDate: "2022-08-20",
      status: "Active",
      phone: "555-0102",
    ...
    },
    {
      ...
      firstName: "Carlos",
      lastName: "Rodriguez",
      email: "carlos@buildcorp.com",
      role: "Foreman",
      site: "Downtown Complex",
      certifications: ["OSHA 30", "Safety Manager"],
      hourlyRate: 40,
      joinDate: "2021-11-05",
      status: "Active",
      phone: "555-0104",
  ...
  const [safetyIncidents, setSafetyIncidents] = useState([
    {
      ...
      description: "Cut on hand from metal sheet",
      status: "Resolved",
    },
    {
      id: 2,
      ...
      description: "Load swing incident",
      status: "Under Review",
    },
    {
      id: 3,
      ...
      description: "Wire stripper malfunction",
      status: "Resolved",
    },
  ]);
  ...
  const stats = [
    ...
    },
    {
      ...
      value: safetyIncidents.filter((i) => i.status === "Under Review").length,
      icon: AlertTriangle,
      color: "red",
    },
    {
    ...
    <div className="space-y-4 max-h-96 overflow-y-auto">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label>Role</Label>
          <Select
            onValueChange={(value) => onSave({ ...employee, role: value })}
          >
            <SelectTrigger>
        ...
        <div>
          <Label>Site</Label>
          <Select
            onValueChange={(value) => onSave({ ...employee, site: value })}
          >
            <SelectTrigger>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 p-6 ml-64">
      <Nav />
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Workforce management for construction sites
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, idx) => (
            <Card
              key={idx}
              className={`bg-white shadow-sm border-l-4 border-l-${stat.color}-500`}
            >
                  ...
                  <div className="space-y-3">
                    {Object.entries(attendance.sites).map(([site, count]) => (
                      ...
                      >
                        ...
                        <Badge variant="secondary">{count} workers</Badge>
                      </div>
                    ))}
                  </div>
                </CardContent>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {payroll.processed
                              ...
                              : `${payroll.totalHours} hours scheduled`}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {incident.employee} • {incident.site}
                          </p>
                          <p className="text-sm text-gray-500">
