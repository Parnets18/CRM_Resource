          ...
          <div className="flex justify-between items-center mb-8">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="border border-purple-500/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-black">Pending Indent Requests</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {indentRequests.map((request) => (
                  <motion.div 
                    key={request.id}
                    whileHover={{ x: 5 }}
                    className="group flex items-center justify-between p-3 rounded-lg bg-gray-100/50 relative"
                  >
                    {request.urgent && (
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-700">
                        {request.project}
                        {request.urgent && (
                          <span className="ml-2 px-2 py-1 bg-red-100 text-red-600 text-xs rounded-full">Urgent</span>
                        )}
                      </p>
            ...
            <Card className="border border-purple-500/20 bg-white/80 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-black">Project Prioritization</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="p-3 rounded-lg bg-gray-100/50">
                  <p className="text-sm font-medium text-gray-700 mb-4">Active Projects</p>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={project.id} className="flex items-center justify-between p-2 rounded-lg bg-gray-200/50">
