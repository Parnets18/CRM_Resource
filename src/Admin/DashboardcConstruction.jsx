...
const siteData = [
  ...
  { id: 4, name: "Shopping Mall", location: "Chennai", progress: 20, status: "Just Started", manager: "Neha Patel" },
]
...
const indentData = [
  { id: 1, item: "Cement Bags", quantity: 500, site: "Commercial Tower", status: "Approved", urgency: "High" },
  { id: 2, item: "Steel Rods", quantity: 200, site: "Residential Complex", status: "Pending", urgency: "Medium" },
  { id: 3, item: "Bricks", quantity: 5000, site: "Highway Project", status: "Issued", urgency: "Low" },
  { id: 4, item: "Sand", quantity: 20, site: "Shopping Mall", status: "Rejected", urgency: "Medium" },
]

const employeeData = [
  { id: 1, name: "Rajesh Kumar", role: "Site Supervisor", site: "Commercial Tower", attendance: "Present" },
  { id: 2, name: "Sunil Verma", role: "Worker", site: "Residential Complex", attendance: "Absent" },
  { id: 3, name: "Meena Gupta", role: "Engineer", site: "Highway Project", attendance: "Present" },
  { id: 4, name: "Anil Sharma", role: "Worker", site: "Shopping Mall", attendance: "Present" },
]

const expenseData = [
  { id: 1, description: "Diesel Purchase", amount: 12000, site: "Commercial Tower", status: "Approved" },
  { id: 2, description: "Local Transport", amount: 5000, site: "Residential Complex", status: "Pending" },
  { id: 3, description: "Equipment Rental", amount: 25000, site: "Highway Project", status: "Approved" },
  { id: 4, description: "Office Supplies", amount: 3000, site: "Shopping Mall", status: "Rejected" },
]

const purchaseData = [
  { id: 1, poNumber: "PO-2025-001", vendor: "ABC Suppliers", amount: 250000, status: "Delivered" },
  { id: 2, poNumber: "PO-2025-002", vendor: "XYZ Materials", amount: 180000, status: "In Transit" },
  { id: 3, poNumber: "PO-2025-003", vendor: "PQR Traders", amount: 320000, status: "Pending Approval" },
  { id: 4, poNumber: "PO-2025-004", vendor: "LMN Enterprises", amount: 95000, status: "Ordered" },
]

const salesData = [
  { id: 1, invoiceNumber: "INV-2025-001", client: "ABC Constructions", amount: 1500000, status: "Paid" },
  { id: 2, invoiceNumber: "INV-2025-002", client: "XYZ Developers", amount: 2200000, status: "Partial" },
  { id: 3, invoiceNumber: "INV-2025-003", client: "PQR Builders", amount: 1800000, status: "Unpaid" },
  { id: 4, invoiceNumber: "INV-2025-004", client: "LMN Properties", amount: 3500000, status: "Paid" },
]

const alertData = [
  { id: 1, message: "Cement stock below reorder level", type: "Inventory", severity: "High" },
  { id: 2, message: "Task 'Electrical Wiring' is delayed", type: "Task", severity: "Medium" },
  { id: 3, message: "Worker attendance below 80% at Residential Complex", type: "HR", severity: "Medium" },
  { id: 4, message: "Invoice INV-2025-003 payment overdue", type: "Finance", severity: "High" },
]
...
export default function ConstructionDashboard() {
  ...
  const filteredTasks =
    selectedSite === "all"
      ? taskData
      : taskData.filter((task) => task.site.toLowerCase().includes(selectedSite.toLowerCase()))

  const filteredIndents =
    selectedSite === "all"
      ? indentData
      : indentData.filter((indent) => indent.site.toLowerCase().includes(selectedSite.toLowerCase()))

  // Calculate statistics
  const totalSites = siteData.length
  const completedTasks = taskData.filter((task) => task.status === "Completed").length
  const pendingTasks = taskData.filter((task) => task.status !== "Completed").length
  const totalEmployees = employeeData.length
  const presentEmployees = employeeData.filter((emp) => emp.attendance === "Present").length
          ...
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  <span className="text-green-500 flex items-center">
                    <ArrowUpRight className="h-3 w-3 mr-1" /> 8% completion rate
                  </span>
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  <span className="text-green-500 flex items-center">
                    <ArrowUpRight className="h-3 w-3 mr-1" /> 95% present today
                  </span>
                </p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">₹{(profit / 100000).toFixed(2)}L</h3>
                <p className="text-xs text-muted-foreground mt-1">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="flex items-center">
            <AlertTriangle className="mr-2 h-5 w-5 text-amber-500" /> Alerts & Notifications
          </CardTitle>
            ...
            {alertData.map((alert) => (
              ...
              >
                <div className="flex items-center">
                  {alert.type === "Inventory" && <Package className="h-5 w-5 mr-2 text-gray-700" />}
                  {alert.type === "Task" && <Clock className="h-5 w-5 mr-2 text-gray-700" />}
                  {alert.type === "HR" && <Users className="h-5 w-5 mr-2 text-gray-700" />}
                  {alert.type === "Finance" && <DollarSign className="h-5 w-5 mr-2 text-gray-700" />}
                  <div>
        ...
        <TabsContent value="sites">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage all your active construction sites</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="tasks">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track and manage all construction tasks</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="inventory">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track material requests and inventory status</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs font-medium bg-red-100 text-red-800 px-2 py-1 rounded-full">High</span>
                      </div>
                      <div className="flex justify-between items-center">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">June 1-5, 2025</p>
                        </div>
                        <div className="flex space-x-1">
                          <Button variant="outline" size="sm" className="h-7 px-2">
                            <CheckCircle className="h-3 w-3" />
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-4 font-medium">Site</th>
                    <th className="text-left py-3 px-4 font-medium">Today's Status</th>
                    <th className="text-left py-3 px-4 font-medium">Actions</th>
                  </tr>
                </thead>
                <tbody>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <Card>
                  ...
                  <CardContent className="pt-2">
                    ...
                    <div className="text-xs text-muted-foreground mt-1">5 expenses awaiting approval</div>
                    <div className="mt-4 space-y-2">
                      <div className="flex justify-between text-sm">
        ...
        <TabsContent value="purchase">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage purchase orders and vendor transactions</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <Card>
                ...
                <Card>
                  ...
                  <CardContent className="pt-2">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="text-sm font-medium">Cement (300 bags)</p>
                          <p className="text-xs text-muted-foreground">ABC Suppliers</p>
                        </div>
                        <p className="text-xs">May 25, 2025</p>
                      </div>
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="text-sm font-medium">Steel (5 tons)</p>
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          <p className="text-sm font-medium">Bricks (10,000 pcs)</p>
                          <p className="text-xs text-muted-foreground">PQR Traders</p>
                        </div>
        ...
        <TabsContent value="sales">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track sales, invoices, and client payments</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <Card>
