...
export default function PurchaseManagement() {
  ...
  const getStatusColor = (status) => {
    if (["Approved", "Complete", "Completed", "Confirmed"].includes(status)) return "bg-green-100 text-green-800"
    if (["Pending", "New", "Scheduled", "Under Review"].includes(status)) return "bg-blue-100 text-blue-800"
    if (["Rejected", "Cancelled", "Overdue"].includes(status)) return "bg-red-100 text-red-800"
    ...
    <div className="min-h-screen bg-white text-black p-4 md:p-6">
      ...
      <AnimatePresence>
        {successMessage && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -50 }}
            className="fixed top-4 right-4 z-50 bg-green-500/90 text-black px-4 py-3 rounded-lg shadow-lg flex items-center"
          >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-black">Manage your complete purchase lifecycle</p>
        </div>
        <button
          className="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg text-black transition-colors flex items-center gap-2 shadow-lg"
        ...
        {purchaseStats.map((stat, index) => (
          ...
          >
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-sm text-black">{stat.title}</h3>
      ...
      <div className="bg-white/90 border border-purple-700/30 rounded-lg overflow-hidden mb-6 shadow-md">
        <div className="p-4 border-b border-purple-700/30 flex justify-between items-center">
          ...
          <button
            className="p-1 rounded-lg hover:bg-purple-900/30 text-black hover:text-black transition-colors"
            onClick={() => updateStats()}
          >
          ...
          <button
            ...
            className={`px-4 py-2 whitespace-nowrap flex items-center ${
              activeTab === stage.id
                ...
                : "text-black hover:text-black hover:bg-purple-900/10"
            } transition-colors`}
            onClick={() => setActiveTab(stage.id)}
          >
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white/90 border border-purple-700/30 rounded-lg focus:outline-none focus:border-purple-500 text-black shadow-sm"
            value={searchTerm}
      ...
      <div className="bg-white/90 border border-purple-700/30 rounded-lg overflow-hidden shadow-md">
        {isLoading ? (
          ...
          <>
            {/* Table Header */}
            <div className="grid grid-cols-12 gap-4 p-4 border-b border-purple-700/30 bg-white/40 text-xs font-medium text-black uppercase">
              <div
                className="col-span-4 flex items-center cursor-pointer hover:text-black transition-colors"
              ...
              {filteredItems.length > 0 ? (
                filteredItems.map((item) => (
                  <div key={item.id} className="grid grid-cols-12 gap-4 p-4 hover:bg-purple-900/10 transition-colors">
                    ...
                    <div className="col-span-2 text-black flex items-center">
                    ...
                    <div className="col-span-2 flex items-center justify-end space-x-2">
                      <button
                        className="p-1.5 rounded-lg hover:bg-purple-900/30 text-black hover:text-black transition-colors"
                        onClick={() => handleViewDetails(item)}
                        title="View Details"
                      >
                        <Eye size={16} />
                      ...
                      <button
                        className="p-1.5 rounded-lg hover:bg-red-900/30 text-black hover:text-red-400 transition-colors"
                      ...
                      <div className="relative">
                        ...
                        {actionMenuOpen === item.id && (
                          <div className="absolute right-0 mt-2 w-48 bg-gray-900 border border-purple-700/30 rounded-lg shadow-lg z-10 py-1">
                            <button
                              className="w-full text-left px-4 py-2 text-sm text-black hover:bg-purple-900/20 hover:text-black transition-colors flex items-center"
                              onClick={() => {
                                setSelectedItem(item)
                                setActionMenuOpen(null)
                ...
                <div className="p-8 text-center text-black flex flex-col items-center">
            ...
            <div className="flex justify-between items-center p-4 border-t border-purple-700/30">
              <div className="text-sm text-black">
                Showing <span className="font-medium text-black">1-{filteredItems.length}</span> of{" "}
                <span className="font-medium text-black">{activeStage.count}</span> items
              </div>
              <div className="flex gap-1">
                <button
                  className="px-3 py-1.5 rounded-lg bg-white/90 border border-purple-700/30 text-black hover:text-black hover:bg-purple-900/20 transition-colors disabled:opacity-50"
                  disabled
                >
                  Previous
                </button>
                <button className="px-3 py-1.5 rounded-lg bg-white/90 border border-purple-700/30 text-black hover:text-black hover:bg-purple-900/20 transition-colors">
                  Next
                </button>
              </div>
            </div>
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm text-black mb-1">Contact Information</h3>
                ...
                <div>
                  <h3 className="text-sm text-black mb-1">Details</h3>
                  <div className="bg-white/30 rounded-lg p-3 space-y-2">
                ...
                <div>
                  <h3 className="text-sm text-black mb-1">Notes</h3>
                ...
                <div className="pt-4 border-t border-purple-700/30">
                  <h3 className="text-sm text-black mb-3">Actions</h3>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-4">
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white/30 border border-purple-700/30 rounded-lg focus:outline-none focus:border-purple-500 text-black"
                      required
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-black mb-1">Initial Order Value*</label>
                      <input
                        type="text"
                        name="value"
                ...
                <div className="flex justify-end gap-3 mt-6">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 bg-purple-600 rounded-lg text-black hover:bg-purple-700 transition-colors shadow-md"
                  >
                    Add Vendor
                  </button>
                </div>
          ...
          >
            ...
            >
              ...
              <p className="text-black mb-6">
                Are you sure you want to delete <span className="text-black font-medium">{selectedItem?.name}</span>?
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  className="px-4 py-2 bg-red-600 rounded-lg text-black hover:bg-red-700 transition-colors shadow-md"
          ...
          >
            ...
            >
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  <label className="block text-sm text-black mb-1">Date Range</label>
                  <select
