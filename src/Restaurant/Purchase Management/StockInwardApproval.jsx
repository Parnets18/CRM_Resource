...
Generated on: ${new Date().toLocaleString()}
  ...
  // Responsive Stock Card for mobile
  const StockCard = ({ stock }) => (
    ...
    >
      <div className="flex justify-between items-center">
        <span className="font-semibold text-black">{stock.grnNumber}</span>
        <Badge
          variant="outline"
          className={
      ...
      <div className="flex flex-wrap gap-2 text-sm text-gray-700">
        <span>PO: {stock.poNumber}</span>
        <span>Receipt: {stock.receiptDate}</span>
        <span>Qty: {stock.quantity}</span>
      </div>
      <div className="text-sm text-gray-700">
        <span className="font-medium">Items:</span> {stock.items}
      </div>
      <div className="flex gap-2 mt-2">
        ...
        <Button
          ...
          onClick={(e) => {
            e.stopPropagation();
            handleDownloadStockReport(stock);
          }}
        >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-700 mt-2">
              Approve or reject incoming stock for inventory
            </p>
          </div>
        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Badge
                        variant="outline"
                        className={
                          selectedStock.status === "Approved"
                            ? "border-green-500/50 text-green-700"
                            : selectedStock.status === "Rejected"
                            ? "border-red-500/50 text-red-700"
                            : "border-yellow-500/50 text-yellow-700"
                        }
                      >
                  ...
                  <div>
                    ...
                    <p className="text-black font-medium">
                      {selectedStock.notes || "No additional notes"}
                    </p>
                  </div>
                </div>
              </CardContent>
