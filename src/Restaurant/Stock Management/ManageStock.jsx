              ...
              <CardContent>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent className="bg-white border-gray-300 text-black">
                          <SelectItem value="supplier-a">
                            Supplier A
                          </SelectItem>
                          <SelectItem value="supplier-b">
                            Supplier B
                          </SelectItem>
                          <SelectItem value="supplier-c">
                            Supplier C
                          </SelectItem>
                        </SelectContent>
                      </Select>
                  ...
                  <StockEntryList
                    ...
                    addEntry={addStockEntry}
                    removeEntry={removeStockEntry}
                  />
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
                    ...
                    >
                      <ArrowUpCircle className="w-4 h-4 mr-2" /> Record Stock
                      Inward
                    </Button>
                  </div>
                </form>
              ...
              <CardContent>
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="entryReason" className="text-gray-700">
                        Entry Reason
                      </Label>
                      <Select>
                        <SelectTrigger className="bg-gray-100 border-gray-300 text-black">
                        ...
                        <SelectContent className="bg-white border-gray-300 text-black">
                          <SelectItem value="initial-stock">
                            Initial Stock
                          </SelectItem>
                  ...
                  <div className="flex justify-end">
                    <Button
                      ...
                      className="bg-purple-600 hover:bg-purple-700 text-white w-full sm:w-auto"
                    >
                      <ArrowUpCircle className="w-4 h-4 mr-2" /> Record Manual
                      Entry
                    </Button>
                  </div>
                </form>
    ...
    <div className="border border-gray-300 rounded-lg p-4 mb-6 bg-white">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-2">
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="border-purple-500/20 text-purple-700"
          onClick={addEntry}
        >
      ...
      {entries.map((entry, index) => (
        <div
          key={entry.id}
          className="grid grid-cols-1 sm:grid-cols-5 gap-2 sm:gap-4 mb-4"
        >
          <div>
            <Select>
              <SelectTrigger className="bg-gray-100 border-gray-300 text-black">
