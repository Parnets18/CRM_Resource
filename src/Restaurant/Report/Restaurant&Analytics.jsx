        ...
        <div className="max-w-7xl mx-auto mt-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Monitor sales, profits, inventory, and customer insights
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
              <div>
                ...
                <select
                  ...
                  className="border border-gray-300 rounded-md px-2 py-2 text-xs sm:text-sm w-full"
                >
            ...
            <div className="p-2 sm:p-6">
              ...
              {activeTab === 'sales' && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                      ...
                      <div className="space-y-3">
                        {Object.entries(
                          ...
                          <div key={category} className="flex justify-between items-center">
                            ...
                            <span className="text-xs sm:text-sm text-gray-600">${total.toFixed(2)}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    {/* Top Items */}
                    <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                      <h3 className="text-base sm:text-lg font-semibold mb-4">Top Selling Items</h3>
                      <div className="space-y-3">
                        {Object.entries(
                          analytics.filteredSales.reduce((acc, sale) => {
                          ...
                          .map(([item, quantity]) => (
                            <div key={item} className="flex justify-between items-center">
                              ...
                              <span className="text-xs sm:text-sm text-gray-600">{quantity} sold</span>
                            </div>
                          ))}
                      </div>
                    </div>
                  ...
                  {/* Recent Sales Table */}
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    <h3 className="text-base sm:text-lg font-semibold mb-4">Recent Sales</h3>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                        <thead className="bg-gray-100">
                          <tr>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Date</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Item</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Category</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Table</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Qty</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Price</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Profit</th>
                          </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                          {analytics.filteredSales.map(sale => (
                            <tr key={sale.id}>
                              <td className="px-2 sm:px-4 py-3 text-gray-900">{sale.date}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-900">{sale.item}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{sale.category}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{sale.table}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{sale.quantity}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-900">${sale.price.toFixed(2)}</td>
                              <td className="px-2 sm:px-4 py-3 text-green-600">${(sale.price - sale.cost).toFixed(2)}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
              ...
              {activeTab === 'inventory' && (
                <div className="space-y-6">
                  ...
                  {/* All Stock Items */}
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    <h3 className="text-base sm:text-lg font-semibold mb-4">All Stock Items</h3>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                        <thead className="bg-gray-100">
                          <tr>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Item</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Quantity</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Purchase Date</th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">Expiry Date</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {mockStockData.map(item => {
                            ...
                            return (
                              <tr key={item.id}>
                                <td className="px-2 sm:px-4 py-3 text-gray-900">{item.item}</td>
                                <td className="px-2 sm:px-4 py-3 text-gray-600">
                                  {item.quantity} {item.unit}
                                </td>
                                <td className="px-2 sm:px-4 py-3 text-gray-600">{item.purchaseDate}</td>
                                <td className="px-2 sm:px-4 py-3 text-gray-600">{expiryDate.toLocaleDateString()}</td>
              ...
              {activeTab === 'crm' && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                    {/* Customer Segments */}
                    <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                      <h3 className="text-base sm:text-lg font-semibold mb-4">Customer Segments</h3>
                      <div className="space-y-3">
                        {Object.entries(
                    ...
                    {/* Average Scores */}
                    <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                      <h3 className="text-base sm:text-lg font-semibold mb-4">Average Scores</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-xs sm:text-sm font-medium">Frequency</span>
                          <span className="text-xs sm:text-sm text-gray-600">
                            {(
                              crmMetrics.reduce((sum, c) => sum + parseFloat(c.frequencyScore), 0) /
                              crmMetrics.length
                            ).toFixed(1)}
                            /10
                          </span>
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-xs sm:text-sm font-medium">Recency</span>
                          <span className="text-xs sm:text-sm text-gray-600">
                            {(
                              crmMetrics.reduce((sum, c) => sum + parseFloat(c.recencyScore), 0) /
                              crmMetrics.length
                            ).toFixed(1)}
                            /10
                          </span>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xs sm:text-sm text-gray-600">
                            {(
                              crmMetrics.reduce((sum, c) => sum + parseFloat(c.valueScore), 0) /
                              crmMetrics.length
                            ).toFixed(1)}
                            /10
                          </span>
                    ...
                    {/* Top Customers */}
                    <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                      <h3 className="text-base sm:text-lg font-semibold mb-4">Top Customers</h3>
                      <div className="space-y-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                    <h3 className="text-base sm:text-lg font-semibold mb-4">
                      Customer Analytics (RFV Scoring)
                    </h3>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                        <thead className="bg-gray-100">
                          <tr>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">
                              Customer
                            </th>
                            <th className="px-2 sm:px-4 py-3 text-left font-medium text-gray-500 uppercase">
                              Segment
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {crmMetrics.map(customer => (
                            <tr key={customer.id}>
                              <td className="px-2 sm:px-4 py-3 text-gray-900">{customer.name}</td>
                              <td className="px-2 sm:px-4 py-3">
                                <span
                                  className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${
                              ...
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{customer.frequencyScore}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{customer.recencyScore}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{customer.valueScore}</td>
                              <td className="px-2 sm:px-4 py-3 font-medium text-gray-900">{customer.totalScore}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-600">{customer.lastVisit}</td>
                              <td className="px-2 sm:px-4 py-3 text-gray-900">${customer.totalSpent}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
