...
import { Plus, Trash2, Printer, Gauge, Percent } from "lucide-react";
        ...
        <div className="flex-1 p-4 md:p-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-3 bg-gray-100 border border-gray-300 mb-6">
              <TabsTrigger
                value="tax"
                className="flex items-center gap-2 text-black text-xs md:text-base"
              >
                <Percent className="h-4 w-4" /> <span className="hidden xs:inline">Tax Slabs</span>
              </TabsTrigger>
              <TabsTrigger
                value="units"
                className="flex items-center gap-2 text-black text-xs md:text-base"
              >
                <Gauge className="h-4 w-4" /> <span className="hidden xs:inline">Units</span>
              </TabsTrigger>
              <TabsTrigger
                value="printers"
                className="flex items-center gap-2 text-black text-xs md:text-base"
              >
                <Printer className="h-4 w-4" /> <span className="hidden xs:inline">Kitchen Printers</span>
              </TabsTrigger>
            </TabsList>
              ...
              >
                <Card className="border border-blue-500/20 bg-white backdrop-blur-sm mb-6">
                  <CardHeader className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                    ...
                    <Button
                      onClick={addNewTax}
                      className="bg-purple-600 hover:bg-purple-700 text-white w-full md:w-auto mt-2 md:mt-0"
                    >
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {taxSlabs.map((tax) => (
                          ...
                          >
                            <TableCell className="font-medium text-black min-w-[120px]">
                              <Input
                                value={tax.name}
                                onChange={(e) =>
                                  setTaxSlabs(
              ...
              >
                <Card className="border border-blue-500/20 bg-white backdrop-blur-sm mb-6">
                  <CardHeader className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                    ...
                    <Button
                      onClick={addNewUnit}
                      className="bg-purple-600 hover:bg-purple-600 text-white w-full md:w-auto mt-2 md:mt-0"
                    >
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 p-4 bg-gray-100 rounded-lg">
                          <div>
                            <Label className="text-gray-700">
                              Print Order Copies
                            </Label>
          ...
          {!selectedRestaurant && (
            ...
            >
              ...
              <p className="text-gray-700 max-w-md">
                Please select a restaurant from the dropdown above to configure
                its settings.
              </p>
            </motion.div>
          )}
