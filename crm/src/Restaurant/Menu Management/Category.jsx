...
import { Plus, Trash2, Edit, Utensils, ChevronDown, ChevronUp, Leaf, Beef } from "lucide-react";
...
export default function MenuManagement() {
    ...
    const menuItems = [
        { id: 1, name: "Spring Rolls", category: "Starters", subcategory: "Veg", price: 5.99, status: "Available", ingredients: "Vegetables, wrappers" },
        { id: 2, name: "Chicken Wings", category: "Starters", subcategory: "Non-Veg", price: 8.99, status: "Available", ingredients: "Chicken, spices" },
        { id: 3, name: "Paneer Tikka", category: "Main Course", subcategory: "Veg", price: 12.99, status: "Available", ingredients: "Paneer, spices" },
        { id: 4, name: "Butter Chicken", category: "Main Course", subcategory: "Non-Veg", price: 14.99, status: "Available", ingredients: "Chicken, butter, spices" },
        { id: 5, name: "Masala Chai", category: "Beverages", subcategory: "Hot", price: 2.99, status: "Available", ingredients: "Tea, spices, milk" },
        { id: 6, name: "Mango Lassi", category: "Beverages", subcategory: "Cold", price: 3.99, status: "Available", ingredients: "Yogurt, mango" },
    ];
                ...
                <div className="flex-1 p-8">
                    ...
                    <div className="flex gap-3 mb-6 flex-wrap">
                        ...
                        <Button 
                            ...
                            className={activeFilter === "Veg" ? "bg-green-600" : "border-gray-700"}
                        ...
                        <Button 
                            ...
                            className={activeFilter === "Non-Veg" ? "bg-red-600" : "border-gray-700"}
                        ...
                        <Button 
                            ...
                            className={activeFilter === "Hot" ? "bg-orange-600" : "border-gray-700"}
                        ...
                        <Button 
                            ...
                            className={activeFilter === "Cold" ? "bg-blue-600" : "border-gray-700"}
                    ...
                    <div className="space-y-6">
                        {categories.map((category) => {
                            ...
                            return (
                                <Card key={category.name} className="border border-purple-500/20 bg-black/80 backdrop-blur-sm">
                                    <CardHeader className="p-4 cursor-pointer" onClick={() => toggleCategory(category.name)}>
                                            ...
                                            <Table>
                                                <TableHeader>
                                                    <TableRow className="hover:bg-transparent">
                                                        <TableHead className="text-gray-300 w-[40%]">Item</TableHead>
