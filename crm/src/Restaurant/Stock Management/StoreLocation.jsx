        ...
        <div className="flex-1 p-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-gray-400">Manage your inventory locations</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {locations.map((location) => (
              <Card key={location.id} className="border border-purple-500/20 bg-black/80 backdrop-blur-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <p className="text-gray-300">{location.manager}</p>
                      </div>
                      <div>
                        <p className="text-gray-500">Contact</p>
                        <p className="text-gray-300">{location.contact}</p>
                      </div>
                    </div>
                    <div className="pt-2 border-t border-gray-800 mt-4">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-500">Items in location</span>
                        <span className="text-white font-medium">{location.itemCount}</span>
                      </div>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <Input id="manager" className="bg-gray-800 border-gray-700" />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="contact">Contact Number</Label>
                <Input id="contact" className="bg-gray-800 border-gray-700" />
              </div>
            </div>
          </div>
          <DialogFooter>
            ...
            <Button className="bg-purple-600 hover:bg-purple-700">Save Location</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="bg-gray-900 border border-purple-500/20 text-white">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              ...
              <Input id="edit-name" className="bg-gray-800 border-gray-700" defaultValue={selectedLocation?.name} />
            </div>
            <div className="grid gap-2">
          ...
          <DialogFooter>
            ...
            <Button className="bg-purple-600 hover:bg-purple-700">Update Location</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
